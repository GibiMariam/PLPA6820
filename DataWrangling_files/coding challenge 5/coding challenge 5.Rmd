...
---
https://github.com/GibiMariam/PLPA6820/tree/1c4092dfab7426adf510e3f7ea33e77cf9cb7340/DataWrangling_files/coding%20challenge%205 
...
ggplot(alpha_plot, aes(x = Time_Point, y = value, color = diff, group = diff)) +
  geom_line(size = 1.2) +
  geom_point(size = 3) +
  labs(
    x = "Time Point",
    y = "Difference in Evenness",
    color = "Crop Difference") +
